...
<a href="{{ route('addresses.create') }}">+ Tambah Alamat Baru</a><br><br>
...
@if($addresses->count() > 0)
    <table border="1" cellpadding="8" cellspacing="0">
        <tr><th>No</th><th>Judul</th><th>Penerima</th><th>Telepon</th><th>Alamat Lengkap</th><th>Kota</th><th>Aksi</th></tr>
        ...
        <tr>
            ...
            <td>{{ $address->city }}</td>
            <td>
                <a href="{{ route('addresses.edit', $address) }}">Ubah</a>
